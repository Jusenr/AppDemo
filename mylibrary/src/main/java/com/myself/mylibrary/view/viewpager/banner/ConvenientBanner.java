package com.myself.mylibrary.view.viewpager.banner;
...
import com.myself.mylibrary.view.viewpager.banner.adapter.CBPageAdapter;
import com.myself.mylibrary.view.viewpager.banner.holder.CBViewHolderCreator;
import com.myself.mylibrary.view.viewpager.banner.listener.CBPageChangeListener;
import com.myself.mylibrary.view.viewpager.banner.listener.OnBannerItemClickListener;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public void setAdapter(CBPageAdapter adapter) {
     ...
     * @param value
     */
    public void setPageIndicatorMarginBottom(int value) {
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) loPageTurningPoint.getLayoutParams();
     ...
     */
    public ConvenientBanner setOnItemClickListener(OnBannerItemClickListener onItemClickListener) {
        if (onItemClickListener == null) {
            viewPager.setOnBannerItemClickListener(null);
            return this;
        }
        viewPager.setOnBannerItemClickListener(onItemClickListener);
        return this;
    }
...
//        Log.d("ConvenientBanner", "onDetachedFromWindow: " + hashCode());
//        if (isTurning())
//            stopTurning();
//    }
//
...
//        Log.d("ConvenientBanner", "onAttachedToWindow: " + hashCode());
