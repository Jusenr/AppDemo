...
/**
 * 弹跳加载布局
 * Created by guchenkai on 2015/12/31.
 */
public class JumpLoadingLayout extends View {
    ...
    public JumpLoadingLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initStyleable(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.JumpLoadingLayout);
        color = array.getColor(R.styleable.JumpLoadingLayout_jump_color, Color.parseColor("#0000FF"));
        array.recycle();
    }
