package com.myself.mylibrary.view.picker.util;
 ...
 */
public class PickerDateUtils extends android.text.format.DateUtils {
    public static final String TAG = PickerDateUtils.class.getSimpleName();
    ...
    public static long[] calculateDifference(long differentMilliSeconds) {
        ...
        Log.d(TAG, String.format("different: %d ms, %d days, %d hours, %d minutes, %d seconds",
    ...
    public static String long_2_str(long timeStamp, String dataFormat) {
        ...
        return new SimpleDateFormat(dataFormat).format(new Date(timeStamp));
    }
