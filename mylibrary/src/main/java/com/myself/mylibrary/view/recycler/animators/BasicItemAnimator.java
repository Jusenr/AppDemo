package com.myself.mylibrary.view.recycler.animators;
 ...
 */
public class BasicItemAnimator extends RecyclerView.ItemAnimator {
...
//    @Override
    ...
    private void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim.setListener(new VpaListenerAdapter() {
                @Override
                public void onAnimationStart(View view) {
                    onAnimationStarted(changeInfo.oldHolder);
                }
                ...
                public void onAnimationEnd(View view) {
                    ...
                    ViewCompat.setTranslationX(view, 0);
                    ViewCompat.setTranslationY(view, 0);
                    onAnimationFinished(changeInfo.oldHolder);
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0).translationY(0).setDuration(getChangeDuration()).
                ...
                @Override
                public void onAnimationStart(View view) {
                    onAnimationStarted(changeInfo.newHolder);
                }
                ...
                public void onAnimationEnd(View view) {
                    ...
                    onAnimationFinished(changeInfo.newHolder);
    ...
    public void endAnimations() {
        ...
        for (int i = count - 1; i >= 0; i--) {
            ...
            ViewCompat.setTranslationY(view, 0);
            ViewCompat.setTranslationX(view, 0);
            onAnimationFinished(item.holder);
            mPendingMoves.remove(i);
        }
        ...
        for (int i = listCount - 1; i >= 0; i--) {
            ...
            for (int j = count - 1; j >= 0; j--) {
                ...
                ViewCompat.setTranslationY(view, 0);
                ViewCompat.setTranslationX(view, 0);
                onAnimationFinished(moveInfo.holder);
                moves.remove(j);
                if (moves.isEmpty())
                    mMovesList.remove(moves);
            }
