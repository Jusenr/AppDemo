package com.myself.mylibrary.view.picker.widget;
...
public class PickerWheelView extends ScrollView {
    private static final String TAG = PickerWheelView.class.getSimpleName();
    ...
    public PickerWheelView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setSelection(int position) {
        setSelection(false, position);
    }

    public void setSelection(final boolean smoothScroll, int position) {
