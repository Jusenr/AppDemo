...
public class AddressPicker extends WheelPicker {
    ...
    protected View initContentView() {
        ...
        final PickerWheelView provinceView = new PickerWheelView(activity);
        ...
        final PickerWheelView cityView = new PickerWheelView(activity);
        ...
        final PickerWheelView countyView = new PickerWheelView(activity);
        ...
        provinceView.setOnWheelViewListener(new PickerWheelView.OnWheelViewListener() {
            @Override
        ...
        cityView.setItems(cityList.get(selectedProvinceIndex));
        cityView.setOnWheelViewListener(new PickerWheelView.OnWheelViewListener() {
            @Override
            public void onSelected(int selectedIndex, String item) {
                selectedCity = item;
        ...
        countyView.setItems(countyList.get(selectedProvinceIndex).get(selectedCityIndex));
        countyView.setOnWheelViewListener(new PickerWheelView.OnWheelViewListener() {
            @Override
            public void onSelected(int selectedIndex, String item) {
                selectedCounty = item;
            }
