...
package com.myself.mylibrary.controller.eventbus.handler;

import android.os.Handler;
import android.os.HandlerThread;

import com.myself.mylibrary.controller.eventbus.EventBusSubscription;
...
public class AsyncEventHandler implements EventHandler {
     ...
     * @param event
     */
    public void handleEvent(final EventBusSubscription subscription, final Object event) {
